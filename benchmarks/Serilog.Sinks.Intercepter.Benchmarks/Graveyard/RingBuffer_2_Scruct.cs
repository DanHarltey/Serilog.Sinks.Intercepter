...
{
    internal sealed class RingBuffer_2_Scruct
    {
        ...
        public RingBuffer_2_Scruct(int capacity)
        {
        ...
        {
            private readonly RingBuffer_2_Scruct _buffer;

            public RingBufferEnumerable(RingBuffer_2_Scruct buffer)
            {
                _buffer = buffer;
            }
        ...
        {
            private readonly RingBuffer_2_Scruct _ringBuffer;
            private int _index = -1;

            public RingBufferEnumerator(RingBuffer_2_Scruct ringBuffer)
            {
